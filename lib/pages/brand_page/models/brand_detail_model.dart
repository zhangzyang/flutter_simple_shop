...
class BrandDetailModel {
  ...
  factory BrandDetailModel.fromJson(Map<String, dynamic> jsonRes){ if(jsonRes == null){return null;}
  final List<BrandDetailGoodsList> list = jsonRes['list'] is List ? <BrandDetailGoodsList>[]: null;
  if(list!=null) {
    for (final dynamic item in jsonRes['list']) { if (item != null) { list.add(BrandDetailGoodsList.fromJson(asT<Map<String,dynamic>>(item)));  } }
  }


  return BrandDetailModel( list:list,
...
class BrandDetailGoodsList {
  ...
  factory BrandDetailGoodsList.fromJson(Map<String, dynamic> jsonRes){ if(jsonRes == null){return null;}
  final List<Object> specialText = jsonRes['specialText'] is List ? <Object>[]: null;
  if(specialText!=null) {
    for (final dynamic item in jsonRes['specialText']) { if (item != null) { specialText.add(asT<Object>(item));  } }
  }


  return BrandDetailGoodsList(id : asT<int>(jsonRes['id']),
